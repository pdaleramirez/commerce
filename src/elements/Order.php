...
class Order extends Element
{
    ...
    use OrderElementTrait {
    	defineTableAttributes as DepotiseDefineTableAttributes;
		defineDefaultTableAttributes as DepotiseDefineDefaultTableAttributes;
		tableAttributeHtml as DepotiseTableAttributeHtml;
	}
	...
	public static function indexHtml(ElementQueryInterface $elementQuery, array $disabledElementIds = null, array $viewState, string $sourceKey = null, string $context = null, bool $includeContainer, bool $showCheckboxes): string
	{
		...
		if ($bodyParams['criteria']['siteId'] == Craft::$app->sites->getPrimarySite()->id) {
			$elementQuery->siteId = Craft::$app->sites->getAllSiteIds();
		}
	...
	{
		$table = static::DepotiseDefineTableAttributes();
	...
	{
		$table = static::DepotiseDefineDefaultTableAttributes($source);

		return array_merge($table, ['siteId']);
	}
